(function (root) {
  ...
  root.OpenTTSConstants = {
    ...
    PLAYBACK_HIGH_WATER_SECONDS: 20,
    PLAYBACK_LOW_WATER_SECONDS: 10,
    PLAYBACK_MAX_DECODED_BYTES: 16 * 1024 * 1024,
    PLAYBACK_STARTUP_LEAD: 0.25,
